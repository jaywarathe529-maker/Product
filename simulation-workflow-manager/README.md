...
1. Interview researchers from molecular- and process-simulation groups.
2. Map their workflow from input preparation to analysis.
3. Identify common sources of lost context and repeated work.
...
The initial product focuses on scientific simulations rather than generic task management. Domain-specific parameter templates, reproducibility checks, and result comparison form the core value proposition.

## Key risks
Supporting too many simulation formats, large-file storage costs, confidential research data, cluster integration complexity, and incorrect automatic parsing.
